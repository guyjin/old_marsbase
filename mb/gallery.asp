...
%>
<h1><%=choice%></h1>
<p> <a href="display.asp?subject=<%=choice%>" class="nav"><%=choice%></a><br>
...
<table border="0" width=20% cellspacing="3" cellpadding="3" align="center">
		...
		<a href="images/<%=choice%>/<%=rsCont("picname")%>.jpg"><img src="images/<%=choice%>/<%=rsCont("picname")%>small.jpg" align="right" border="0"></a>
		</td>  
